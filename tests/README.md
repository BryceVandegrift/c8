...
Binary files for testing CHIP-8 emulators.

All files in this directory are from
[this GitHub repo](https://github.com/Timendus/chip8-test-suite)
...
![CHIP-8 logo, shown on the display](./pics/chip-8-logo.png)
...
![IBM logo, shown on the display](./pics/ibm-logo.png)
...
![Corax89's opcode test](./pics/corax+.png)
...
![Choosing a target platform in the quirks test](./pics/quirks-platform.png)
...
![Showing the active quirks](./pics/quirks.png)
...
![Choosing the opcode to test in the keypad test](./pics/keypad-menu.png)
...
![The `Ex9E` keypad test, when pressing keys 1 and 6](./pics/keypad-down.png)
...
![The `ExA1` keypad test, when pressing keys 1 and 6](./pics/keypad-up.png)
...
![The `Fx0A` keypad test, when all is good](./pics/keypad-getkey.png)
...
![The beep test beeping](./pics/beep.png)
